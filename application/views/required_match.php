                ...
                <div class="col-md-12 col-sm-12 no-padding">
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 no-padding">
                        ...
                        <div class="col-md-8 col-sm-8 col-xs-12">
                            <input type="checkbox" name="looking[]" id="NeverMarried" value="NeverMarried"><label> Never Married</label>&nbsp                
                            <input type="checkbox" name="looking[]" value="Separated" id="Separated"> <label>Separated </label>&nbsp                
                            <input type="checkbox" name="looking[]" value="Divorced" id="Divorced"> <label>Divorced</label>&nbsp            
                            <input type="checkbox" name="looking[]" value="Widow/Widower" id="Widow"> <label>Widow/Widower </label>&nbsp                                        
                    ...
                    <div class="col-md-6 col-sm-8 col-xs-12">
                        ...
                        <select name="agefrom" id="agefrom" class="col-md-4 col-sm-4 col-xs-4 select-opt no-padding form-control input-sm">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input class="mrgn-ll" type="radio" name="education" value="DoesNotMatter"> <label>Doesn't Matter</label>&nbsp                
                        <input type="radio" name="education" value="Educated"> <label>Education </label>&nbsp
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12" style="display:none" id="chooseeducation">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <input class="mrgn-ll" type="radio" name="occupation" value="DoesNotMatter"> <label> Doesn't Matter</label>&nbsp                
                    ...
                    <div class="form-group col-md-12 col-sm-12 col-xs-12 no-padding" id="anualincomee">
                    <div class="col-md-4 col-sm-4 col-xs-12">
